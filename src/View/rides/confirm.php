<section class="page-hero page-hero-compact">
    <div class="container">
        <p class="hero-kicker">Reservation</p>
        <h1>Confirmer la participation</h1>
        <p>Verifiez le trajet, le prix en credits et confirmez votre participation.</p>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="auth-layout">
            ...
            <aside class="auth-aside">
                ...
                <ul class="check-list">
                    <li>Votre solde est verifie avant la confirmation</li>
                    <li>Les places restantes sont mises a jour automatiquement</li>
                    <li>Vous pouvez retrouver ce trajet dans votre espace</li>
                </ul>
            </aside>
        </div>
    </div>
